...
if (isset($_GET['delete_user'])) {
    $ok = $users->delete_user($_GET['delete_user']);

 if ($ok) {
        $msg = "<div class='alert alert-success' style='margin: 4px'>
                <button class='close' data-dismiss='alert'>&times;</button>
                <strong>Success</strong> User Has Been Delete
             </div> ";
...
<head>
    ...
    <title>Manage User's - Charity</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Manage User's</strong>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="dropdown text-center">
                                                <button id="dropdownMenu1" class="btn btn-primary dropdown-toggle btn-width" data-toggle="dropdown">
                                                    ...
                                                    <li><a role="menuitem" tabindex="-1" href="edit_user.php?id=<?php echo $row['id'] ?>" class="dropdown-item">Edit</a></li>
                                                    <div tabindex="-1" class="dropdown-divider"></div>
                                                    <li><a role="menuitem" tabindex="-1" href="manage_users.php?delete_user=<?php echo $row['id'] ?>" class="dropdown-item">Delete</a></li>
                                                    </ul>
                                            </div></td>
                                        </tr> 
                                      <?php 
