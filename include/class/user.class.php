...
class User 
{
    ...
    public function update_user($id,$user_name,$user_email,$user_pass,$user_adrs,$client_phone,$user_dob){
        ...
        GLOBAL $mysqli;
        $user_pass = md5($user_pass);
        $users = $mysqli->query("UPDATE user SET user_name = '$user_name', user_email = '$user_email', $user_pass = '$user_pass' , user_adrs = '$user_adrs', user_phone = '$client_phone', user_dob = '$user_dob'  WHERE id = '$id'");
        return $users;
